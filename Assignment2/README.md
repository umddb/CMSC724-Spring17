...
It should be possible install Spark on your local machine without much trouble. But we have also provided a `VagrantFile` that instantiates a VM to use if you'd like. You will need to install VirtualBox and Vagrant in order to use it. See the instructions here: [Instructions](https://github.com/umddb/cmsc424-fall2016/tree/master/project0)
...
2. Move the downloaded file to the `Assignment2/` directory, and uncompress it using: 
`tar zxvf spark-2.0.1-bin-hadoop2.7.tgz`
3. This will create a new directory: `spark-2.0.1-bin-hadoop2.7`. 
4. Set the SPARKHOME variable: `export SPARKHOME=XXX/Assignment2/spark-2.0.1-bin-hadoop2.7`
